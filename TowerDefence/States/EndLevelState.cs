...
namespace TowerDefence.States
{
    public class EndLevelState : State
    {
        ...
        public EndLevelState(Game1 game, GraphicsDevice graphics, int levelId, bool isWon) : base(game, graphics)
        {
            ...
            position = new Vector2(width, Constans.WindowHeight / 10);
        ...
        {
            spriteBatch.Draw(TextureManager.EndBackground, new Rectangle(0, 0, Constans.WindowWidth, Constans.WindowHeight), Color.White);
